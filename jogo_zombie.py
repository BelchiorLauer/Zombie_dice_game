...
# print("o numeor de jogardores é ", num1 gutter to run the script.
"""
-- Belchior Lauer Da Silva 
...
# Objeto para construir os diferentes dados
class Dado(object):
    # construtor
...
def inicio():
    ...
    print("\tBelchior Lauer Da Silva")
    print("\tAnálise e Desenvolimento de Sistemas")
    print(monta_rodape_secao())
    print("")
